...
function wpeHeaderScripts() {
  if (!is_admin()) {
    ...
    wp_register_script('owl', get_template_directory_uri() . '/js/owl.carousel.min.js', array(), '1.32');
...
if (function_exists('register_sidebar')) {
  ...
  register_sidebar(array(
    ...
    'id' => 'widgetarea1',
    'before_widget' => '<div id="%1$s" class="widget %2$s ty-sidebox-important">',
    'after_widget' => '</div></div></div>',
    'before_title' => '<h3 class="ty-sidebox-important__title"><span class="ty-sidebox__title-wrapper">',
    'after_title' => '</span></h3><div class="ty-sidebox-important__body"><div class="ty-blog-sidebox">'
  ));
...
function easy_breadcrumbs() {
  ...
  if ( !is_front_page() ) {
    ...
    echo '<div class="row"><div class="span16 "><div id="breadcrumbs_10"><div class="ty-breadcrumbs clearfix"><ul id="' . $breadcrums_id . '" class="' . $breadcrums_class . '">';
...
function disable_emojicons_tinymce( $plugins ) {
  if ( is_array( $plugins ) ) {
	...
	// Add news Post Type
  add_action( 'init', 'register_cpts_product' );
  function register_cpts_product() {
    /**
     * Post Type: Products.
    */
    ...
    'name' => __( 'Products', 'wpeasy' ),
      'singular_name' => __( 'Product', 'wpeasy' ),
  ...
  add_action( 'init', 'register_taxes_products' );
  function register_taxes_products() {
    /**
     * Taxonomy: Product Category
    */

    $labels = array(
      'name' => __( 'Product Categories', 'wpeasy' ),
      'singular_name' => __( 'Category', 'wpeasy' ),
      'menu_name' => __( 'Product Category', 'wpeasy' ),
      'search_items' => __( 'Search', 'wpeasy' ),
    ...
    $args = array(
      'label' => __( 'Product Category', 'wpeasy' ),
      'labels' => $labels,
      'public' => true,
      'publicly_queryable' => true,
      'hierarchical' => true,
